...
def compress_DNA(original_file, final_huffmans_trees, window_length, start_time):
    ...
    for tree_key in temp:        
       	os.system("brotli -c " + tree_key + ".txt > " + tree_key + ".txt.br")
        print "window_length", window_length, "label_length", label_length, tree_key, os.path.getsize(tree_key + ".txt"), os.path.getsize(tree_key + ".txt.br"), float(os.path.getsize(tree_key + ".txt.br"))/os.path.getsize(tree_key + ".txt")
       	os.system("rm " + tree_key + ".txt")
        os.system("7za a " + original_file_name + ".ost.7z " + tree_key + ".txt.br &>> " + original_file_name + ".log")
      	s += os.path.getsize(tree_key + ".txt.br")
        os.system("rm " + tree_key + ".txt.br")
...
############ Decompression ###########################      
    ...
    for key in tree_code_dictionary:
        ...
        os.system("brotli -d -c " + tree_code_dictionary[key] + ".txt.br > " + tree_code_dictionary[key] + ".txt" )      
        os.system("rm " + tree_code_dictionary[key] + ".txt.br" + " &>> " + labels_stream_bin_file + ".log")
