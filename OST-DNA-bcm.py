...
def compress_DNA(original_file, final_huffmans_trees, window_length, start_time):
    ...
    for tree_key in temp:        
       	os.system("/gcrf/KHCC/CTAG/NGS/tools_installation/bcm/src/bcm " + tree_key + ".txt &>> " + original_file_name + ".log")
        print "window_length", window_length, "label_length", label_length, tree_key, os.path.getsize(tree_key + ".txt"), os.path.getsize(tree_key + ".txt.bcm"), float(os.path.getsize(tree_key + ".txt.bcm"))/os.path.getsize(tree_key + ".txt")
       	os.system("rm " + tree_key + ".txt")
        os.system("7za a " + original_file_name + ".ost.7z " + tree_key + ".txt.bcm &>> " + original_file_name + ".log")
      	s += os.path.getsize(tree_key + ".txt.bcm")
        os.system("rm " + tree_key + ".txt.bcm")
...
############ Decompression ###########################      
    ...
    for key in tree_code_dictionary:
        ...
        os.system("/gcrf/KHCC/CTAG/NGS/tools_installation/bcm/src/bcm -d -f " + tree_code_dictionary[key] + ".txt.bcm"  + " &>> " + labels_stream_bin_file + ".log")      
        os.system("rm " + tree_code_dictionary[key] + ".txt.bcm" + " &>> " + labels_stream_bin_file + ".log")
