...
def compress_DNA(original_file, final_huffmans_trees, window_length, start_time):
    ...
    for tree_key in temp:        
       	os.system("lzip -c " + tree_key + ".txt > " + tree_key + ".txt.lz")
        print "window_length", window_length, "label_length", label_length, tree_key, os.path.getsize(tree_key + ".txt"), os.path.getsize(tree_key + ".txt.lz"), float(os.path.getsize(tree_key + ".txt.lz"))/os.path.getsize(tree_key + ".txt")
       	os.system("rm " + tree_key + ".txt")
        os.system("7za a " + original_file_name + ".ost.7z " + tree_key + ".txt.lz &>> " + original_file_name + ".log")
      	s += os.path.getsize(tree_key + ".txt.lz")
        os.system("rm " + tree_key + ".txt.lz")
...
############ Decompression ###########################      
    ...
    for key in tree_code_dictionary:
        ...
        os.system("lzip -d -c " + tree_code_dictionary[key] + ".txt.lz > " + tree_code_dictionary[key] + ".txt")      
        os.system("rm " + tree_code_dictionary[key] + ".txt.lz" + " &>> " + labels_stream_bin_file + ".log")
