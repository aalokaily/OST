...
def compress_DNA(original_file, final_huffmans_trees, window_length, start_time):
    ...
    for tree_key in temp:        
       	os.system("bzip2 -k -c " + tree_key + ".txt > " + tree_key + ".txt.bz2")
        print "window_length", window_length, "label_length", label_length, tree_key, os.path.getsize(tree_key + ".txt"), os.path.getsize(tree_key + ".txt.bz2"), float(os.path.getsize(tree_key + ".txt.bz2"))/os.path.getsize(tree_key + ".txt")
       	os.system("rm " + tree_key + ".txt")
        os.system("7za a " + original_file_name + ".ost.7z " + tree_key + ".txt.bz2 &>> " + original_file_name + ".log")
      	s += os.path.getsize(tree_key + ".txt.bz2")
        os.system("rm " + tree_key + ".txt.bz2")
...
############ Decompression ###########################      
    ...
    for key in tree_code_dictionary:
        ...
        os.system("bunzip2 " + tree_code_dictionary[key] + ".txt.bz2 &>> " + labels_stream_bin_file + ".log")      
        os.system("rm " + tree_code_dictionary[key] + ".txt.bz2" + " &>> " + labels_stream_bin_file + ".log")
